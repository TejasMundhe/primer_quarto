...
<!-- MF: MChanged Population Table and validity, stability, representativeness --> 
...
<!-- Do we really believe the posterior for male/female expected years lived? No! Or, at the very least, we are suspicious. -->
...
<!-- broom.mixed generates a weird warning about TMB was built with Matrix version -->
<!-- 1.3.4 and Current Matrix version is 1.3.3. Not sure what to do, besides turn -->
<!-- it off for now. -->
...
$\beta_0$ is our intercept, around `r round(coef(fit_2)["(Intercept)"], 0)` years. In this type of model, our intercept represents the the variable which is not represented in the model. Therefore, the intercept value represents those who are not male (females). 
...
These questions are, purposely, less precise than the ones we tackled in @sec-two-parameters and @sec-three-parameters, written more in a conversational style. This is how normal people talk.
