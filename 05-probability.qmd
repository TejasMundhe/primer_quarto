...
```{r hidden-libraries, echo = FALSE, message = FALSE, warning = FALSE}
...
```{r, echo = FALSE}
# When I try to use `fmt_percent(portion, decimals = 0)`, it works
# interactively. But, when knitting the whole chapter, you get 19prcnt and
# similar nonsense. This link may be relevant:

# https://stackoverflow.com/questions/67952525/escaping-symbol-in-gt-package-function-fmt-percent

# Really ought to submit a reprex to R Studio Community.
...
```{r, echo = FALSE}
# Yuhan: This stopped working sometime in the last year. Not sure why.
...
Recall from @sec-wrangling how we can draw randomly from specified probability distributions:
