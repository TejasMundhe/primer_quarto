...
<!-- SZ: Sounds a lot more confusing than it really is, maybe adding two tables side-by-side to compare would help?  Agreed. Please do this! Very simple case. Table only has one row. Still use Yao example. -->
...
<!-- DK: Do you two table trick. A descriptive table only has one outcome table, labeled Y. -->
